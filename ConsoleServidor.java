...
public class ConsoleServidor implements Runnable {

	public static void main(String[] args) {
		
		new ConsoleServidor().comenzar();
	...
	public void comenzar(){
		...
		if(!crearConexionFTPServer()){	
			System.out.println("Fallo al crear la conexion ftp por lo tanto todo fallo!");
		}
		else{
		...
		public void run(){
			...
			try{
				...
				while(true){
					...
					System.out.println(pr.getId_usuario_envio()+"\t"+pr.getMensaje()+"\t"+pr.getId_usuario_destino()+"\n");
